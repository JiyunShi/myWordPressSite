 ...
 */
function jspage_customize_register( $wp_customize ) {
	...
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
        ...
        $wp_customize->add_setting('theme_bg_color', [
            'default' =>'#002254',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'interactive_color', array(
				'label'		=> __( 'Interactive color (links etc)', 'jspage' ),
				'section'	=> 'colors',
	...
	$wp_customize->add_section( 'theme_options', 
		array(
			'title'			=> __( 'Theme Options', 'jspage' ),
			'priority'		=> 95,
			'capability'	=> 'edit_theme_options',
			'description'	=> __( 'Change how much of a post is displayed on index and archive pages.', 'jspage' )
		)
	);
	...
	$wp_customize->add_setting('length_setting',
		array(
			'default'			=> 'excerpt',
			'type'				=> 'theme_mod',
			'sanitize_callback' => 'jspage_sanitize_length', // Sanitization function appears further down
			'transport'			=> 'postMessage'
		)
	);
	...
	$wp_customize->add_control('jspage_length_control',
		array(
			...
			'choices'	=> array(
				'excerpt'		=> __( 'Excerpt (default)', 'jspage' ),
				'full-content'	=> __( 'Full content', 'jspage' )
			),
...
add_action( 'customize_register', 'jspage_customize_register' );

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function jspage_customize_preview_js() {
	wp_enqueue_script( 'jspage_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'jspage_customize_preview_js' );
...
function jspage_sanitize_length( $value ) {
...
if ( ! function_exists( 'jspage_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see jspage_custom_header_setup().
 */
function jspage_header_style() {
